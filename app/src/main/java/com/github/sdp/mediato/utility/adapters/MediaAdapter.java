...
public abstract class MediaAdapter extends RecyclerView.Adapter<MediaAdapter.UserViewHolder> {

    private final MainActivity mainActivity;
    private final SearchMediaViewModel searchMediaViewModel;

    public MediaAdapter(MainActivity mainActivity, SearchMediaViewModel searchMediaViewModel) {
        this.mainActivity = mainActivity;
        this.searchMediaViewModel = searchMediaViewModel;
    }
